        ...
        <div class="nav-links">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="bus/trial.php"><i class="fas fa-car"></i> Cab</a>
                    <a href="train_flight/public/index.php"><i class="fas fa-plane"></i> Flights</a>
                    <a href="train_flight/public/index.php"><i class="fas fa-train"></i> Train</a>
                </div>
            </div>
