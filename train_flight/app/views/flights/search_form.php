<?php
// app/views/flights/search_form.php
...
<head>
    <meta charset="UTF-8">
    <title>Search Flights - Travelease</title>
...
<body>
    ...
    <div class="container" style="padding-top: 100px;">
        <h1 class="form-title">Search Flights</h1>
        ...
        <br>
        <a href="index.php?controller=Flight&action=bookingHistory" class="btn">View Booking History</a>
    </div>
</body>
</html>